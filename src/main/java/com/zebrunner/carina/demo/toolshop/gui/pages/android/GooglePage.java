...
public class GooglePage extends GooglePageBase {
    ...
    private ExtendedWebElement googleSearchInput;
    ...
    private ExtendedWebElement switchTabBtn;
    ...
    public boolean isSearchInputPresent() {
        return googleSearchInput.isElementPresent();
    }
